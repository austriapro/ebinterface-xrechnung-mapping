...
public final class XRechnungCIIInvoiceToEbInterface61ConverterTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (XRechnungCIIInvoiceToEbInterface61ConverterTest.class);
  ...
  public void testXRechnung122 ()
  {
    for (final File aFile : new FileSystemIterator (new File ("src/test/resources/external/xrechnung/122/cii")).withFilter (IFileFilter.filenameEndsWith (".xml")))
    {
      ...
      final Ebi61InvoiceType aEbi = new XRechnungCIIInvoiceToEbInterface61Converter (LOC,
