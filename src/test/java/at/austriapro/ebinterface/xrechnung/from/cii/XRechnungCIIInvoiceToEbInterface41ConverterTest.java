...
import at.austriapro.ebinterface.xrechnung.from.cii.XRechnungCIIInvoiceToEbInterface41Converter;
import un.unece.uncefact.data.standard.crossindustryinvoice._100.CrossIndustryInvoiceType;

public final class XRechnungCIIInvoiceToEbInterface41ConverterTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (XRechnungCIIInvoiceToEbInterface41ConverterTest.class);
  ...
  public void testBasic ()
  {
    for (final File aFile : new FileSystemIterator (new File ("src/test/resources/xrechnung/cii")).withFilter (IFileFilter.filenameEndsWith (".xml")))
    {
      ...
      final Ebi41InvoiceType aEbi = new XRechnungCIIInvoiceToEbInterface41Converter (LOC,
