...
public final class XRechnungUBLInvoiceToEbInterface61ConverterTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (XRechnungUBLInvoiceToEbInterface61ConverterTest.class);
  ...
  public void testXRechnung122 ()
  {
    for (final File aFile : new FileSystemIterator (new File ("src/test/resources/external/xrechnung/122/ubl")).withFilter (IFileFilter.filenameEndsWith ("_ubl.xml")))
    {
      ...
      final Ebi61InvoiceType aEbi = new XRechnungUBLInvoiceToEbInterface61Converter (LOC,
