...
import com.helger.ebinterface.xrechnung.from.ubl.XRechnungUBLInvoiceToEbInterface42Converter;
...
{
  private static final Logger LOGGER = LoggerFactory.getLogger (XRechnungUBLInvoiceToEbInterface42ConverterTest.class);
  ...
  public void testBasic ()
  {
    for (final File aFile : new FileSystemIterator (new File ("src/test/resources/xrechnung/ubl")).withFilter (IFileFilter.filenameEndsWith ("_ubl.xml")))
    {
      ...
      final Ebi42InvoiceType aEbi = new XRechnungUBLInvoiceToEbInterface42Converter (LOC,
