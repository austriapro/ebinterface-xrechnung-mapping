...
/**
 * Convert XRechnung CII to ebInterface 6.1
 *
 * @author Philip Helger
 */
public class XRechnungCIIInvoiceToEbInterface61Converter extends AbstractXRechnungCIIToEbInterfaceConverter
{
                                   ...
                                   @NonNull final ErrorList aTransformErrorList)
  {
    ...
    return new XRechnungUBLInvoiceToEbInterface61Converter (m_aDisplayLocale,
                                                            m_aContentLocale).setCustomizer (m_aCustomizer)
                                                                             .convert (aUBLInvoice,
                                                                                       aTransformErrorList);
  }
}
