 ...
 */
public class EbInterface60ToXRechnungUBLConverter extends AbstractEbInterfaceToXRechnungUBLConverter
{
  ...
  public InvoiceType convert (@Nonnull final Ebi60InvoiceType aEbiInvoice, @Nonnull final ErrorList aTransformErrorList)
  {
    ...
    final InvoiceType aUBLInvoice = new EbInterface60ToInvoiceConverter (m_aDisplayLocale, m_aContentLocale).convertInvoice (aEbiInvoice);
